...
mkdir c:\temp
Set "pastatemp=c:\temp"
Set "pastaprojeto=sts-4.12.0.RELEASE"
Set "url=https://download.springsource.com/release/STS4/4.12.0.RELEASE/dist/e4.21/spring-tool-suite-4-4.12.0.RELEASE-e4.21.0-win32.win32.x86_64.self-extracting.jar"
